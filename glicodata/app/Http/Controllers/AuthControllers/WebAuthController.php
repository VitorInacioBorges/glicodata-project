...
class WebAuthController extends Controller
{
    ...
    public function login(WebLoginRequest $request): RedirectResponse
    {
        ...
        return redirect()->intended($accountType === AccountType::Ubs ? route('ubs.lobby') : route('admin.dashboard'));
    }
    ...
    public function logout(Request $request, string $accountType): RedirectResponse
    {
        ...
        return redirect()->route($type === AccountType::Ubs ? 'ubs.login' : 'admin.login');
    }
